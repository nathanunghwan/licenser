...
name_list=['kim','pak','park','yi','lee','choi','jun','chon','song','sung','sun','gang','kang','ko','chung','jung','cho','yoon','chang','jang','yim','lim','han','oh','seo','suh','shin','kwon','hwang','ahn','an','hong','yoo','ryu','you', 'moon','mun','yang','son','bae','nam', 'shim','sim','noh','no','ha','gwak','guak','cha','goo','gu','yim','im','min','na','eom','ji','chae','won','bang', 'hyun','ham','byun','yeo','chu','do','so','sun','sul','suhl','ma','joo','yeon','goo','koo','woo']
city_list=['at','al','no','ma','jo','su','du','bu','ro']
licenser=[]
for i in name_list:
    # for j in city_list:
    try:
